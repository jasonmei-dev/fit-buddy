...
user1.workouts.create(name: "Workout 1", duration_mins: 15, share_status: true, created_at: 70.hours.ago)
lift_b = Workout.create(name: "Workout 8", duration_mins: 90, user_id: 2, share_status: false)
user1.workouts.create(name: "Workout 6", duration_mins: 45, share_status: false, created_at: 25.hours.ago)
user1.workouts.create(name: "Workout 4", duration_mins: 30, share_status: false, created_at: 50.hours.ago)
...
user2.workouts.create(name: "Workout 1", duration_mins: 15, share_status: true, created_at: 70.hours.ago)
run_b = Workout.create(name: "Workout 8", duration_mins: 90, user_id: 3, share_status: false)
user2.workouts.create(name: "Workout 6", duration_mins: 45, share_status: false, created_at: 25.hours.ago)
user2.workouts.create(name: "Workout 4", duration_mins: 30, share_status: false, created_at: 50.hours.ago)
...
user3.workouts.create(name: "Workout 1", duration_mins: 15, share_status: true, created_at: 75.hours.ago)
bench_b = Workout.create(name: "Workout 8", duration_mins: 90, user_id: 4, share_status: false)
user3.workouts.create(name: "Workout 6", duration_mins: 45, share_status: false, created_at: 25.hours.ago)
user3.workouts.create(name: "Workout 4", duration_mins: 30, share_status: false, created_at: 50.hours.ago)
user3.workouts.create(name: "Workout 2", duration_mins: 15, share_status: false, created_at: 75.hours.ago)
